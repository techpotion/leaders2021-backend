...
var file_sports_objects_proto_goTypes = []interface{}{
	...
	(*SportsObjects_ListRequest)(nil),  // 1: api.SportsObjects.ListRequest
	(*SportsObjects_ListResponse)(nil), // 2: api.SportsObjects.ListResponse
	(*Pagination)(nil),                 // 3: api.Pagination
	(Availability)(0),                  // 4: api.Availability
	(*SportsObject)(nil),               // 5: api.SportsObject
	(*ListStats)(nil),                  // 6: api.ListStats
}
var file_sports_objects_proto_depIdxs = []int32{
	3, // 0: api.SportsObjects.ListRequest.pagination:type_name -> api.Pagination
	4, // 1: api.SportsObjects.ListRequest.availability:type_name -> api.Availability
	5, // 2: api.SportsObjects.ListResponse.sportsObjects:type_name -> api.SportsObject
	6, // 3: api.SportsObjects.ListResponse.listStats:type_name -> api.ListStats
